           ...
           do i=1,ngrid
              ...
              if (ok(i)) then 
                 ...
                 if(ok(i)) then
                    ...
                    ! ex)  (<----,-->): only subtract (<--,-->): result (<--,0)
                    px_div = min( abs(darr(1)*varr(1)),abs(darr(2)*varr(2)))
                    ...
                    isConvergent = darr(4)*uarr(4) - darr(3)*uarr(3) < 0 
                    if (isConvergent) then
                    ...
                    isConvergent = darr(6)*uarr(6) - darr(5)*uarr(5) < 0
                    if (isConvergent) then 
                    ...
                    uarr(5) = varr(5) + Jy/darr(5)
                    uarr(6) = varr(6) - Jy/darr(6)
