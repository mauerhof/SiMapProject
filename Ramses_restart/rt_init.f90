...
!-------------------------------------------------------------------------
  ...
  if(myid==1) print*, 'igroup_HII, ixHI, ixHII : ', igroup_HII, ixHI, ixHII
