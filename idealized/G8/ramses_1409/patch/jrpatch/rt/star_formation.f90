...
! Added tpp and birth_epoch_proper
! RT patch:
! Changed nvar to nhvar
!-------------------------------------------------------------------------
!################################################################
!################################################################
!################################################################
...
subroutine star_formation(ilevel)
  ...
  real(dp)::vxgauss,vygauss,vzgauss,birth_epoch,birth_epoch_proper !---!PT
  ...
  ! Birth epoch
  birth_epoch=t
  birth_epoch_proper=t_proper !----------------------------------------!PT
  ...
  do igrid=1,ncache,nvector
     ...
     do ind=1,twotondim
        ...
        do i=1,nnew
           ...
           tpp(ind_part(i))=birth_epoch_proper !-----------------------!PT
           ...
           if(f_w>0)then
              ...
              tpp(ind_debris(i))=birth_epoch_proper !------------------!PT
