! RT patch:
! nvars replaced with nhvars everywhere and call to interpol_hydrovars
! instead of interpol_hydro 
!-------------------------------------------------------------------------
!###########################################################
!###########################################################
!###########################################################
...
subroutine godfine1(ind_grid,ncache,ilevel)
  ...
  real(dp),dimension(1:nvector,0:twondim  ,1:nhvar),save::u1 !---------!RT
  real(dp),dimension(1:nvector,1:twotondim,1:nhvar),save::u2 !---------!RT
  ...
  do i1=i1min,i1max
     ...
     call interpol_hydrovars(u1,g1,u2,g2,nbuffer) !--------------------!RT
