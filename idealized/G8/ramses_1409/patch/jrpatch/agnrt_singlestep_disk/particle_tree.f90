  ...
  do icpu=1,ncpu
     ...
     if(ncache>0)then
        ...
        if(star.or.sink)then
           if(metal)then
              if(chemo)then
                 allocate(reception(icpu,ilevel)%up(1:ncache,1:twondim+5))
              else
  ...
  do icpu=1,ncpu
     ...
     if(ncache>0)then
        ...
        if(star.or.sink)then
           if(metal)then
              if(chemo)then
                 allocate(emission(icpu,ilevel)%up(1:ncache,1:twondim+5))
              else
...
subroutine fill_comm(ind_part,ind_com,ind_list,np,ilevel,icpu)
  ...
  if(star.or.sink)then
     ...
     if(metal)then
        ...
        if(chemo)then
           do i=1,np
              reception(icpu,ilevel)%up(ind_com(i),twondim+4)=oxp(ind_part(i))
           end do
           do i=1,np
              reception(icpu,ilevel)%up(ind_com(i),twondim+5)=fep(ind_part(i))
           end do
        endif
     end if
  end if
...
subroutine empty_comm(ind_com,np,ilevel,icpu)
  ...
  if(star.or.sink)then
     ...
     if(metal)then
        ...
        if(chemo)then
           do i=1,np
              oxp(ind_part(i))=emission(icpu,ilevel)%up(ind_com(i),twondim+4)
           end do
           do i=1,np
              fep(ind_part(i))=emission(icpu,ilevel)%up(ind_com(i),twondim+5)
           end do
        endif
     end if
  end if
