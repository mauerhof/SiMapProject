module pm_commons
  ...
  real(kind=8),allocatable,dimension(:)::dMBH_coarse,dMEd_coarse,dMsmbh,dMBH_coarse_new,dMsmbh_coarse,dMsmbh_coarse_new
  real(kind=8),allocatable,dimension(:)::dMEd_coarse_new,dMsmbh_new,dMBH_coarse_all,dMEd_coarse_all,dMsmbh_all,dMsmbh_coarse_all
  ...
  real(kind=8),allocatable,dimension(:)::c_avgptr,v_avgptr,d_avgptr
