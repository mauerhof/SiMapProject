module amr_parameters
  ...
  ! Patch perso:----------------------------------------------------------
  real(dp)::eps_sn =1.0D0     ! SN radiation efficiency (1 = 100%) 
  real(dp)::rcell  =2.0D0     ! SN superbubble radius in cells
  ! End patch perso-------------------------------------------------------

  ! DallaVecchia & Schaye feedback:
  real(dp)::SN_dT2_min = 1d0
