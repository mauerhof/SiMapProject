! ideal_SN patch: Added a call to cmp_SN_dtmin for small initial timesteps
!                 and to not overstep SN blast.
...
!  call cmp_SN_dtmin(ilevel,dt_SN) !------------------------------!ideal_SN
!  dt_loc=min(dt_loc,dt_SN) !-------------------------------------!ideal_SN
  ...
  call SN_courant_fine(ilevel,dt_loc) !--------------------------!ideal_SN
