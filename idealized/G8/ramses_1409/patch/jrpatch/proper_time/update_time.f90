...
! Added t_proper, and subroutines getProperTime and getAgeGyrs 
! on nov 18 2009
!-------------------------------------------------------------------------
subroutine update_time(ilevel)
  ...
  if(cosmo)then
     ...
     t_proper &                                                        !PT
          =    t_frw(i  )*(t-tau_frw(i-1))/(tau_frw(i  )-tau_frw(i-1))+ &!
          &    t_frw(i-1)*(t-tau_frw(i  ))/(tau_frw(i-1)-tau_frw(i  )) !PT
  else                                                                 !PT
     t_proper = t                                                      !PT
  end if
...
!------------------------------------------------------------------------
  ...
  age = (t_proper - t_birth_proper) * scale_t_Gyr
...
!------------------------------------------------------------------------
  ...
  age = (t_proper - t_birth_proper) * scale_t_sec
