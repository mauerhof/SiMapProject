subroutine read_hydro_params(nml_ok)
  ...
  !--------------------------------------------------
  namelist/init_params/filetype,filetype_sink,initfile,multiple,nregion,region_type &
  ...
  namelist/refine_params/x_refine,y_refine,z_refine,r_refine &
       ...
       & ,floor_d,floor_u,floor_p,ivar_refine,var_cut_refine,del_Jeans &
       & ,interpol_var,interpol_type,level_zoom,z_init_zoom
  ...
  namelist/physics_params/cooling,haardt_madau,metal,metal_cooling,isothermal,bondi &
       & ,t_star,n_star,T2_star,g_star,del_star,eps_star &
       & ,eta_sn,yield,rbubble,f_ek,ndebris,f_w &
       & ,J21,a_spec,z_ave,z_reion,delayed_cooling &
       & ,n_sink,sink_AGN,rAGN,eAGN_K,eAGN_T,TAGN,T2maxAGN,random_jet &
       & ,X_floor,r_gal,boost,Mseed,jetfrac,sigmav_max,f_bondi,mloadAGN,star_ratio_floor,drag &
       & ,t_ctw,A_snIa,stellar_wind,e_HN,eff_sfbk,chemo,pseudo_sedov,T2max_fix,blazar &
       & ,units_time,units_length,neq_chem,sinkprops,t_delcool,sig_delcool,t_delay
